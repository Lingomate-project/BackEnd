...
router.post('/register', (req, res) =>{
    ...
    //save the username and irreversable encrypted password
    //save gilgamesh@gmailc.com | asdasdasddsada
...
router.post('/login', (req, res) => {
    //get their email and look up the pasword associated with that email in the database
